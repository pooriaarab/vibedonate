...
Read `.agents/design.md` before changing CLI output, prototypes, or launch media.
...
```text
branch:  vdo-<issue>-<slug>          vdo-142-fix-onboarding-drop-off
title:   [VDO-<issue>] <Subject>   [VDO-142] Fix onboarding drop-off
body:    Closes #142
